...
> **[Part 2: The Architecture Framework](genmedia_at_scale_architecture.md)**
...
> **[Part 3: Deep Dive on Evaluation](genmedia_at_scale_evaluation.md)**
...
| **[Part 2](genmedia_at_scale_architecture.md)** | The Architecture Framework | Three pillars, input optimization as a toolkit, the generate-evaluate loop |
| **[Part 3](genmedia_at_scale_evaluation.md)** | Deep Dive: Evaluation | Evaluation methods, strategies, composite scoring, retry budgets |
| **[Part 4](genmedia_at_scale_spinning.md)** | Case Study: Product 360 Spinning | Generic product spinning pipeline with two-level validation |
| **[Part 5](genmedia_at_scale_spinning_shoes.md)** | Case Study: Footwear Spinning | Specialized footwear pipeline with semantic validation |
