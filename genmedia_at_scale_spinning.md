...
Videos that pass the rotation check proceed to **semantic artifact detection** using Gemini as a vision evaluator. The video is sent at a reduced frame rate to keep costs low.
